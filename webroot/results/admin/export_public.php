...
if( $chosenExport ){
  ...
  exportPublic( $CURRENT_EXPORT_FORMAT_VERSION, array(
    ...
    'Competitions' => 'SELECT Competitions.id, Competitions.name, Competitions.cityName, Competitions.countryId, Competitions.information, Competitions.year,
                              Competitions.month, Competitions.day, Competitions.endMonth, Competitions.endDay, (Competitions.cancelled_at IS NOT NULL AND Competitions.cancelled_by IS NOT NULL) AS `cancelled`,
                              replace(GROUP_CONCAT(DISTINCT competition_events.event_id), ",", " ") as eventSpecs,
